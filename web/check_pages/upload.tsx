...
const UploadPage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <Header />
      <main className="container grid py-4 space-y-4 mx-auto md:max-w-screen-lg h-full">
        <div className='py-4 text-center text-2xl px-4 md:px-0 font-bold'>
        ...
        <div className="relative grid h-64 grid-cols-2 gap-4 px-4 md:px-16">
